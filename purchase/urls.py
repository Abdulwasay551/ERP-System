...
from .views import (
    purchaseorders_ui, purchaseorders_add, purchaseorders_edit, purchaseorders_delete,
    suppliers_ui, bills_ui, payments_ui
)
...
urlpatterns = [
    ...
    path('suppliers-ui/', suppliers_ui, name='purchase_suppliers_ui'),
    path('bills-ui/', bills_ui, name='purchase_bills_ui'),
    path('payments-ui/', payments_ui, name='purchase_payments_ui'),
]